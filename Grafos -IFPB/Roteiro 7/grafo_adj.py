        ...
        while fim == False:
            ...
            for i in range(len(vertices)):
                for a in range(len(vertices)):
                    ...
                    if vertices[i] == vez :
                        if arestas[i][a] > 0 and (vertices[a] in visitados) == False:
                            ...
                            while True:
                                ...
                                if v1 == 'nao':
                                    if anterior[procurar1] == vertices[a]:
                                        retorno += ['{}-{}'.format(vertices[i], vertices[a])]
                                        break
                                    if anterior[procurar1] == 'nao':
                                        v1 = 'sim'

                                if v2 == 'nao':
                                    if anterior[procurar2] == vertices[i]:
                                        retorno += ['{}-{}'.format(vertices[i], vertices[a])]
                                        break
                                    if anterior[procurar2] == 'nao':
                                        v2 = 'sim'
                        ...
                        elif a == len(vertices)-1 and anterior[vertices[i]] != 'nao':
                            vez = anterior[vertices[i]]
                        elif vez == inicio2 and len(visitados) == len(vertices):
                            fim = True
                        elif a == len(vertices)-1 and vez == inicio2:
